...
func test_get_spawn_cost_ultra_not_spawnable() -> void:
	...
	var cost = GameConfig.get_spawn_cost(GameConfig.STAGE_ULTRA, "random")
...
func test_get_level_up_cost_formula() -> void:
	...
	for level in [1, 5, 15, 25, 50, 70, 100]:
		var expected = GameConfig.LEVEL_UP_COST_MULTIPLIER * level
		var actual = GameConfig.get_level_up_cost(level)
...
func test_get_base_max_level_all_stages() -> void:
	...
	for stage in range(6):
		var actual = GameConfig.get_base_max_level(stage)
...
func test_get_base_max_level_invalid_returns_1() -> void:
	assert_eq(GameConfig.get_base_max_level(-1), 1, "Invalid stage should return 1")
	assert_eq(GameConfig.get_base_max_level(100), 1, "Out of range stage should return 1")
...
func test_calculate_max_level_no_bonuses() -> void:
	...
	var max_level = GameConfig.calculate_max_level(1, 0, 1)
...
func test_calculate_max_level_with_dp() -> void:
	...
	var max_level = GameConfig.calculate_max_level(1, 3, 1)
...
func test_calculate_max_level_with_origin_bonus() -> void:
	...
	var max_level = GameConfig.calculate_max_level(2, 0, 0)
...
func test_calculate_max_level_full_bonuses() -> void:
	...
	var max_level = GameConfig.calculate_max_level(2, 5, 0)
...
func test_calculate_max_level_mega_high_dp() -> void:
	...
	var max_level = GameConfig.calculate_max_level(4, 10, 1)
...
func test_get_max_reachable_stage_in_training_origin() -> void:
	var max_stage = GameConfig.get_max_reachable_stage(GameConfig.STAGE_IN_TRAINING)
	assert_eq(max_stage, GameConfig.STAGE_CHAMPION,
		"In-Training origin caps at Champion")


func test_get_max_reachable_stage_rookie_origin() -> void:
	var max_stage = GameConfig.get_max_reachable_stage(GameConfig.STAGE_ROOKIE)
	assert_eq(max_stage, GameConfig.STAGE_ULTIMATE,
		"Rookie origin caps at Ultimate")


func test_get_max_reachable_stage_champion_origin() -> void:
	var max_stage = GameConfig.get_max_reachable_stage(GameConfig.STAGE_CHAMPION)
	assert_eq(max_stage, GameConfig.STAGE_MEGA,
...
func test_get_stage_name_all_valid() -> void:
	...
	for stage in range(6):
		var actual = GameConfig.get_stage_name(stage)
...
func test_get_stage_name_invalid() -> void:
	assert_eq(GameConfig.get_stage_name(-1), "Unknown", "Invalid stage should return 'Unknown'")
	assert_eq(GameConfig.get_stage_name(100), "Unknown", "Out of range stage should return 'Unknown'")
...
func test_get_wave_reward_values_early_waves() -> void:
	var rewards = GameConfig.get_wave_reward_values(5)
...
func test_get_wave_reward_values_mid_waves() -> void:
	var rewards = GameConfig.get_wave_reward_values(25)
...
func test_get_wave_reward_values_late_waves() -> void:
	var rewards = GameConfig.get_wave_reward_values(45)
...
func test_get_wave_reward_values_beyond_50() -> void:
	var rewards = GameConfig.get_wave_reward_values(75)
...
func test_get_spawn_interval_endless_min() -> void:
	...
	var interval = GameConfig.get_spawn_interval(200)
	assert_true(interval >= GameConfig.MIN_SPAWN_INTERVAL,
...
func test_grid_to_world() -> void:
	var world_pos = GameConfig.grid_to_world(Vector2i(0, 0))
...
func test_grid_to_world_offset() -> void:
	var world_pos = GameConfig.grid_to_world(Vector2i(2, 3))
...
func test_starting_resources() -> void:
	assert_eq(GameConfig.STARTING_DIGIBYTES, 200, "Starting DigiBytes should be 200")
	assert_eq(GameConfig.STARTING_LIVES, 20, "Starting lives should be 20")


func test_life_penalties() -> void:
	assert_eq(GameConfig.NORMAL_LIFE_PENALTY, 1, "Normal enemy penalty should be 1 life")
	assert_eq(GameConfig.BOSS_LIFE_PENALTY, 3, "Boss penalty should be 3 lives")


func test_combat_constants() -> void:
	assert_eq(GameConfig.CRITICAL_DAMAGE_MULT, 2.0, "Critical damage multiplier should be 2.0")
	assert_eq(GameConfig.BASE_CRITICAL_CHANCE, 0.05, "Base crit chance should be 5%")
	assert_eq(GameConfig.ATTRIBUTE_SUPER_EFFECTIVE, 1.5, "Super effective multiplier should be 1.5")


func test_grid_constants() -> void:
	assert_eq(GameConfig.GRID_COLS, 8, "Grid columns should be 8")
	assert_eq(GameConfig.GRID_ROWS, 18, "Grid rows should be 18")
	assert_eq(GameConfig.TILE_SIZE, 64, "Tile size should be 64")
	assert_eq(GameConfig.TOTAL_TOWER_SLOTS, 87, "Total tower slots should be 87")
	assert_eq(GameConfig.TOTAL_PATH_TILES, 57, "Total path tiles should be 57")
